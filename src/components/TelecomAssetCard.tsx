...
export const TelecomAssetCard: React.FC<TelecomAssetCardProps> = ({
  ...
  return (
    <div className={`rounded-3xl bg-slate-900 border border-slate-800 shadow-xl ${isCompact ? "p-3" : "p-5"}`}>
      <div className={`flex items-center justify-between gap-2 ${isCompact ? "mb-3" : "mb-4"}`}>
      ...
      <div className={`grid grid-cols-2 sm:grid-cols-4 ${isCompact ? "gap-2" : "gap-3"}`}>
        {/* Data / Internet */}
        <div className={`rounded-2xl bg-gradient-to-b from-blue-950/40 to-slate-900 border border-blue-500/20 flex flex-col justify-between ${isCompact ? "p-2.5" : "p-3.5"}`}>
          ...
          <div>
            <div className={`${isCompact ? "text-xl" : "text-2xl"} font-black text-white tracking-tight`}>
              {dataVolGb.toFixed(2)}
            </div>
            <div className={`${isCompact ? "text-[9px]" : "text-[10px]"} text-slate-400 font-medium mt-0.5`}>
              Available Internet
            </div>
          </div>
        </div>
        ...
        {/* Voice / Audio */}
        <div className={`rounded-2xl bg-gradient-to-b from-purple-950/40 to-slate-900 border border-purple-500/20 flex flex-col justify-between ${isCompact ? "p-2.5" : "p-3.5"}`}>
          <div className="flex items-center justify-between mb-2">
        ...
        {/* SMS Messages */}
        <div className={`rounded-2xl bg-gradient-to-b from-amber-950/40 to-slate-900 border border-amber-500/20 flex flex-col justify-between ${isCompact ? "p-2.5" : "p-3.5"}`}>
          <div className="flex items-center justify-between mb-2">
        ...
        {/* Available Airtime */}
        <div className={`rounded-2xl bg-gradient-to-b from-emerald-950/40 to-slate-900 border border-emerald-500/20 flex flex-col justify-between ${isCompact ? "p-2.5" : "p-3.5"}`}>
          <div className="flex items-center justify-between mb-2">
